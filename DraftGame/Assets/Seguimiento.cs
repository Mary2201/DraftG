...
{
    public Transform spongi; // Referencia al transform del jugador (tanque)
    ...
    void Start()
    {
        ...
        offset = transform.position - spongi.position;
    }

    void Update()
    {
        // Calcula la posición objetivo de la cámara
        Vector3 posicionObjetivo = spongi.position + offset;
